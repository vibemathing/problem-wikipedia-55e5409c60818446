...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-55e5409c60818446"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-55e5409c60818446",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-55e5409c60818446",
        "url": "https://en.wikipedia.org/wiki/Kakeya_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "The Kakeya conjecture – do $n$ -dimensional sets that contain a unit line segment in every direction necessarily have Hausdorff dimension and Minkowski dimension equal to $n$ ?",
      "version": 1
    },
    "title": "Kakeya conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "a1be864980e5f89b9750f8f0de96b79f07b31f67d655ed09da66ddafb9b4e841"
}
```
